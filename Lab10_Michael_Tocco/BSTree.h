...
// Destructor
    ...
    double sumKeys() const;                      // return keys

    double getNumerator(double mean);
...
protected:
    ...
    double sumKeysHelper(BSTreeNode* p) const;

    double getNumeratorHelper(BSTreeNode* p, double mean);
